...
// CHANGE: added `onStopSpeaking` prop — CustomerOrder passes window.speechSynthesis.cancel
// so that tapping the mic automatically stops any ongoing AI voice before recording starts.
const ChatBox = ({ messages, isTyping, onSendMessage, disabled, onStopSpeaking }) => {
  ...
  const handleVoiceTranscript = (text) => {
    ...
    // CHANGE: stop TTS before sending so AI voice doesn't get picked up by mic
    ...
    <div className="card shadow-lg border-0 d-flex flex-column" style={{ height: '550px', borderRadius: '20px', overflow: 'hidden' }}>
      ...
      <div className="card-header bg-gradient bg-primary text-white p-3 d-flex align-items-center justify-content-between">
        <div className="d-flex align-items-center">
          ...
          <div>
            <h6 className="mb-0 fw-bold">Bistro AI Waiter</h6>
      ...
      <div className="card-footer bg-white border-0 p-3">
        <form onSubmit={handleSubmit} className="d-flex align-items-center">
          ...
          {/* CHANGE: lang="en-IN" handles English + Hinglish better than en-US */}
          <VoiceInput onTranscript={handleVoiceTranscript} disabled={disabled} lang="en-IN" />
        </form>
      </div>
